...
function poste_deux_declarer_tables_interfaces($interfaces) {
	...
	$interfaces['table_des_tables']['revues'] = 'revues';
...
function poste_deux_declarer_tables_objets_sql($tables) {
	...
	$tables['spip_revues'] = array(
		'type' => 'revue',
		'principale' => "oui",
		'field'=> array(
			"id_revue"           => "bigint(21) NOT NULL",
			"id_rubrique"        => "bigint(21) NOT NULL DEFAULT 0", 
			"id_secteur"         => "bigint(21) NOT NULL DEFAULT 0", 
			"titre"              => "tinytext NOT NULL DEFAULT ''",
			"extrait"            => "text NOT NULL DEFAULT ''",
			"media"              => "tinytext NOT NULL DEFAULT ''",
		...
		'titre' => "titre AS titre, '' AS lang",
		 #'date' => "",
		'champs_editables'  => array('titre', 'extrait', 'media', 'url'),
		'champs_versionnes' => array('titre', 'extrait', 'media', 'url'),
		'rechercher_champs' => array("titre" => 10, "extrait" => 8, "media" => 8),
		'tables_jointures'  => array(),
		'statut_textes_instituer' => array(
			'prepa'    => 'texte_statut_en_cours_redaction',
			'prop'     => 'texte_statut_propose_evaluation',
		...
		'texte_changer_statut' => 'revue:texte_changer_statut_revue', 
